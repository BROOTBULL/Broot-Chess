    ...
    <>
      <div className="flex flex-col h-fit gap-3 w-auto my-auto lg:w-[50%] ">
        ...
        <div
          ...
          className="bg-zinc-800 rounded-lg playButton h-15 md:h-18 hidden lg:flex flex-row items-center justify-center cursor-pointer px-4 shadow-md/50  "
        >
        ...
        <div className="playOptions flex flex-row lg:flex-col gap-2.5  ">
          <div
            ...
            className="bg-zinc-800 rounded-lg playButton h-15 md:h-18 flex flex-row items-center justify-center cursor-pointer shadow-md/50 w-[50%] lg:w-full "
          >
          ...
          <div className="bg-zinc-800 rounded-lg playButton h-15 md:h-18 flex flex-row items-center justify-center cursor-no-drop shadow-md/50 w-[50%] lg:w-full">
