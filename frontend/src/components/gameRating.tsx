...
export const GameRatings=({Ratings}:{Ratings:Rating})=>{
    ...
    return(<>
      <div className="flex flex-row items-center Profile h-fit w-full md:w-[80%] py-1 gap-3 max-w-full justify-between min-[400px]:justify-start mt-auto my-1">
          <div className={`Profile flex-col ${theme?"bg-zinc-500":"bg-zinc-700"} rounded-lg flex size-fit p-3 px-5  shadow-sm/70`}>
          ...
          <div className={`Profile flex-col flex ${theme?"bg-zinc-500":"bg-zinc-700"} rounded-lg size-fit p-3 px-5  shadow-sm/70`}>
