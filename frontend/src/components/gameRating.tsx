...
export const GameRatings=()=>{
    ...
    return(<>
      <div className="flex flex-row items-center Profile h-fit w-full md:w-[80%] py-1 gap-3 max-w-full justify-around min-[500px]:justify-start mt-auto my-1">
          <div className="Profile flex-col bg-zinc-400 rounded-lg flex size-fit p-3 px-5 shadow-md/40">
          ...
          <div className="Profile flex flex-col bg-zinc-400 rounded-lg size-fit p-3 px-5 shadow-md/40">
